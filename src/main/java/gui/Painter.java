...
import structures.implementations.Highway;
import structures.implementations.Landuse;
import structures.implementations.Leisure;
import structures.implementations.Waterway;
...
public class Painter implements DataTags {
    ...
    private void paintLabel(LineString way, String name) {
        ...
        for (int i = 1; i < way.getNumPoints(); i++) {
            ...
            if (upsideDown) {
                offset = (textLength - screenLineLength) - (screenLineLength - textLength) / 2;
            } else {
